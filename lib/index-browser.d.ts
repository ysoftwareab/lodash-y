...
export declare let mixins: {
    ...
    reuseObserver: ((Observer: _mixinsBrowser.ReuseObserverConstructor, isEntryMatch?: _mixinsBrowser.IsEntryMatchFn) => _mixinsBrowser.ReuseObserver) & __.MemoizedFunction;
