...
class CanonicalIntersectionObserver {
  ...
  observe(element, options) {
    let alreadyObserving = _lodash.default.some(this._observerPairs, {
      element,
      options });
    ...
    let observerPair = _lodash.default.find(this._observerPairs, {
      options });
  ...
  unobserve(element, options) {
    let observerPairs = _lodash.default.filter(this._observerPairs, {
      element,
      options });
    ...
    _lodash.default.remove(this._observerPairs, {
      element,
      options });
