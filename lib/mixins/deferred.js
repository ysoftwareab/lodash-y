...
var _asyncCb = require("./async-cb");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
let deferred = function (promise) {
  ...
  if (!_lodash.default.isUndefined(promise)) {
    _lodash.default.defer((0, _asyncCb.asyncCb)(async function () {
      try {
