...
isEntryMatch = _lodash.default.isMatch.bind(_lodash.default))
{
  ...
  observer.observe = function (match, listener, ...observeArgs) {
    ...
    let matchListenersPair = _lodash.default.find(matchListenerPairs, function (matchListenersPair) {
  ...
  let originalUnobserve = _lodash.default.defaultTo(observer.observe, _lodash.default.noop).bind(observer);
  observer.unobserve = function (match, listener, ...unobserveArgs) {
    ...
    _lodash.default.remove(matchListenerPairs, function (matchListenersPair) {
      return matchListenersPair.match === match && matchListenersPair.listener === listener;
    });
    originalUnobserve(...unobserveArgs);
  };

  let originalDisconnect = _lodash.default.defaultTo(observer.disconnect, _lodash.default.noop).bind(observer);
