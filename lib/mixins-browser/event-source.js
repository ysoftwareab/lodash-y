...
class EventSource {constructor() {_defineProperty(this, "_element",
    document.createElement('div'));_defineProperty(this, "_listenerInfos",
  ...
  _removeEventListener(type, listener, options) {
    ...
    let existingListener = _lodash.default.find(this._listenerInfos, function (listenerInfo) {
    ...
    _lodash.default.pull(this._listenerInfos, existingListener);
