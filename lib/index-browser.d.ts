...
export declare let mixins: {
    ...
    abstract: (name?: string) => import("./types").Fn<never, unknown[]>;
    base64: (string: string) => string;
    callbackify: (origFn: import("./types").AsyncFn<unknown, unknown[]>, options?: {
    ...
    limitInParallel: <T extends import("./types").Fn<unknown, unknown[]>>(origFn: T, options?: {
        limit?: number;
        throwErr?: boolean;
    }) => import("./types").FnChangeReturnType<T, _mixins.LimitInParallelError | import("./types").Unpromise<ReturnType<T>>>;
    mapValuesDeep: (origFn: import("./types").Fn<unknown, unknown[]>) => import("./types").Fn<unknown, unknown[]>;
    memoizeTtl: (<T_1 extends import("./types").Fn<unknown, unknown[]>>(ttl: number, origFn: T_1, resolver?: (...args: Parameters<T_1>) => string) => T_1 & __.MemoizedFunction) & {
    ...
    onceIn: <T_2 extends import("./types").Fn<unknown, unknown[]>>(origFn: T_2, interval: number) => T_2 & __.Cancelable;
    outdent: import("outdent").Outdent;
    promisify: (origFn: import("./types").Fn<unknown, unknown[]>, options?: {
        callbackFirst?: boolean;
        errorInCallback?: boolean;
    }) => import("./types").AsyncFn<unknown, unknown[]>;
    safeProxy: (env: __.Dictionary<unknown>) => __.Dictionary<unknown>;
    sleep: (ms?: number) => Promise<void>;
    throttleExp: <T_3 extends import("./types").Fn<unknown, unknown[]>>(origFn: T_3, wait: number, options?: {
        leading?: boolean;
        trailing?: boolean;
        multiplier?: number;
        divider?: number;
    ...
    throttleTrue: <T_2 extends import("./types").Fn<unknown, unknown[]>>(origFn: T_2, interval: number) => T_2 & __.Cancelable;
